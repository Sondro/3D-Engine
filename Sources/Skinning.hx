...
class Skinning
{
	...
	public inline function new(aBones:Array<Bone>) 
	{
		bones = aBones;
		matrices = new Vector(aBones.length * 16);
	}
	public inline function getBonesTransformations():Vector<FastFloat>
	{
		offset = 0;
		for (bone in bones) 
		{
	...
	inline function appendMatrix(list:haxe.ds.Vector<FastFloat>,matrix:FastMatrix4,offset:Int):Void
	{
